...
export const ar: TranslationResources = {
  ...
  panels: {
    ...
    file: {
      ...
      csv: {
        searchPlaceholder: "ابحث في العناوين والصفوف",
        clearSearch: "مسح البحث",
        rowCount: "{{visible}} من أصل {{total}} صفًا",
        firstRowHeader: "الصف الأول عنوان",
        clearFilters: "مسح عوامل التصفية",
        truncated: "تم اقتطاع المعاينة عند حد حجم CSV.",
        raggedRows: "{{count}} صفوف لها عدد حقول غير متوقع",
        jumpToRow: "الانتقال إلى الأول",
        empty: "لا توجد صفوف",
        tooLarge: "ملف CSV كبير جدًا للشبكة. افتح المصدر لعرضه.",
        tooManyValues: "أكثر من {{count}} قيمة مميزة. اكتب للتصفية.",
        filterValues: "تصفية القيم",
        filterAccessibility: "تصفية {{column}}",
        selectAll: "تحديد الكل",
        clear: "مسح",
        ...
        copyCell: "نسخ الخلية",
        copyRow: "نسخ الصف",
        copyVisibleRows: "نسخ الصفوف الظاهرة",
    ...
    notes: {
      label: "الملاحظات",
      subtitle: "ملاحظات المشروع",
      tooltip: "ملاحظات كتبها الوكلاء في هذا المشروع",
      newNote: "ملاحظة جديدة",
      emptyTitle: "لا توجد ملاحظات في هذا المشروع",
      emptyDescription: "يكتبها الوكلاء باستخدام write_note.",
      loadFailed: "فشل تحميل الملاحظات",
      hostTooOld: "حدّث المضيف لعرض الملاحظات.",
      disconnected: "المضيف غير متصل",
      hostsUnavailable: "بعض مضيفي المشروع غير متاحين",
      hostHeading: "{{host}}",
      hostTag: "المضيف: {{host}}",
      hostUnreachable: "لا يمكن الوصول إلى {{host}}.",
      hostUnsupported: "{{host}} لا يدعم الملاحظات.",
      hostLoadFailed: "تعذر تحميل الملاحظات من {{host}}.",
      updated: "تم التحديث {{time}}",
      loadImage: "تحميل صورة بعيدة",
      unsavedChanges: "تغييرات غير محفوظة",
      saving: "جارٍ الحفظ...",
      saveFailed: "فشل الحفظ",
      staleWriteTitle: "تغيّرت الملاحظة أثناء التحرير",
      staleWriteDescription: "استبدل الحفظ الإصدار {{revision}}.",
      changedTitle: "تغيّرت الملاحظة في مكان آخر",
      reload: "إعادة التحميل",
      reloadTitle: "إعادة تحميل الملاحظة؟",
      reloadMessage: "ستفقد تغييراتك المحلية.",
      delete: "حذف",
      deleteTitle: "حذف الملاحظة؟",
      deleteMessage: 'حذف "{{title}}"؟ لا يمكن التراجع عن ذلك.',
      deleteConfirm: "حذف",
      deleteFailed: "فشل حذف الملاحظة",
      deleteConflict: "رُفض الحذف. الملاحظة الآن في الإصدار {{revision}}.",
    },
    pullRequest: {
      label: "طلب السحب",
