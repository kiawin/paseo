...
export const ko: TranslationResources = {
  ...
  sidebar: {
    ...
    workspace: {
      ...
      actions: {
        ...
        hiding: "숨기는 중...",
        delete: "삭제",
        deleteUnavailable: "이 워크스페이스에는 삭제할 worktree가 없습니다",
      },
      confirmations: {
        ...
        hideConfirm: "숨기기",
        deleteTitle: "워크스페이스를 삭제할까요?",
        deleteMessage:
          '"{{workspaceName}}"을(를) 보관하고 node_modules, .env 같은 무시된 파일을 포함한 worktree 디렉터리를 삭제합니다.\n\n커밋되지 않은 작업이 있으면 Git이 거부합니다.',
        deleteConfirm: "삭제",
        cancel: "취소",
      },
      rename: {
      ...
      toasts: {
        ...
        worktreeKeptDirty:
          "보관했습니다. worktree에 커밋되지 않은 작업이 있어 Git이 그대로 두었습니다.",
        worktreeKeptLocked: "보관했습니다. worktree가 잠겨 있어 Git이 그대로 두었습니다.",
        worktreeKeptUnrecognised:
          "보관했습니다. Git이 worktree 디렉터리를 인식하지 못하므로 직접 삭제하세요.",
        worktreeKeptUnknown: "보관했지만 Git이 worktree를 삭제하지 않았습니다.",
      },
    },
  },
  newWorkspace: {
  ...
  panels: {
    ...
    file: {
      ...
      csv: {
        searchPlaceholder: "헤더와 행 검색",
        clearSearch: "검색 지우기",
        rowCount: "{{total}}개 행 중 {{visible}}개",
        firstRowHeader: "첫 번째 행을 헤더로 사용",
        clearFilters: "필터 지우기",
        truncated: "CSV 크기 제한으로 미리보기가 잘렸습니다.",
        raggedRows: "{{count}}개 행의 필드 수가 예상과 다릅니다",
        jumpToRow: "첫 행으로 이동",
        empty: "행이 없습니다",
        tooLarge: "이 CSV는 그리드에 비해 너무 큽니다. 소스를 열어 보세요.",
        tooManyValues: "고유 값이 {{count}}개를 초과합니다. 입력하여 필터링하세요.",
        filterValues: "값 필터",
        filterAccessibility: "{{column}} 필터",
        selectAll: "모두 선택",
        clear: "지우기",
    ...
    notes: {
      label: "노트",
      subtitle: "프로젝트 노트",
      tooltip: "이 프로젝트에서 에이전트가 작성한 노트",
      newNote: "새 노트",
      emptyTitle: "이 프로젝트에 노트가 없습니다",
      emptyDescription: "에이전트가 write_note로 작성합니다.",
      loadFailed: "노트를 불러오지 못했습니다",
      hostTooOld: "노트를 보려면 호스트를 업데이트하세요.",
      disconnected: "호스트 연결이 끊겼습니다",
      hostsUnavailable: "일부 프로젝트 호스트를 사용할 수 없습니다",
      hostHeading: "{{host}}",
      hostTag: "호스트: {{host}}",
      hostUnreachable: "{{host}}에 연결할 수 없습니다.",
      hostUnsupported: "{{host}}는 노트를 지원하지 않습니다.",
      hostLoadFailed: "{{host}}에서 노트를 불러오지 못했습니다.",
      updated: "업데이트됨 {{time}}",
      loadImage: "원격 이미지 로드",
      unsavedChanges: "저장되지 않은 변경사항",
      saving: "저장 중...",
      saveFailed: "저장 실패",
      staleWriteTitle: "편집하는 동안 노트가 변경됨",
      staleWriteDescription: "저장으로 리비전 {{revision}}을(를) 대체했습니다.",
      changedTitle: "다른 곳에서 노트가 변경됨",
      reload: "다시 로드",
      reloadTitle: "노트를 다시 로드할까요?",
      reloadMessage: "로컬 변경사항이 손실됩니다.",
      delete: "삭제",
      deleteTitle: "노트를 삭제할까요?",
      deleteMessage: '"{{title}}"을(를) 삭제할까요? 취소할 수 없습니다.',
      deleteConfirm: "삭제",
      deleteFailed: "노트 삭제 실패",
      deleteConflict: "삭제가 거부되었습니다. 노트는 현재 리비전 {{revision}}입니다.",
    },
    pullRequest: {
      label: "풀 리퀘스트",
