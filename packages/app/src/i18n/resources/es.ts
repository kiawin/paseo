...
export const es: TranslationResources = {
  ...
  sidebar: {
    ...
    workspace: {
      ...
      actions: {
        ...
        hiding: "Ocultación...",
        delete: "Eliminar",
        deleteUnavailable: "Este espacio de trabajo no tiene un worktree que eliminar",
      },
      confirmations: {
        ...
        deleteTitle: "¿Eliminar el espacio de trabajo?",
        deleteMessage:
          'Archiva "{{workspaceName}}" y elimina su directorio de worktree, incluidos los archivos ignorados como node_modules y .env.\n\nGit se niega si hay trabajo sin confirmar.',
      ...
      toasts: {
        ...
        worktreeKeptDirty:
          "Archivado. El worktree tiene trabajo sin confirmar, así que Git lo conservó.",
        worktreeKeptLocked: "Archivado. El worktree está bloqueado, así que Git lo conservó.",
        worktreeKeptUnrecognised:
          "Archivado. Git ya no reconoce el directorio del worktree, así que elimínalo tú.",
        worktreeKeptUnknown: "Archivado, pero Git no eliminó el worktree.",
      },
    },
  },
  newWorkspace: {
  ...
  panels: {
    ...
    file: {
      ...
      csv: {
        searchPlaceholder: "Buscar en encabezados y filas",
        clearSearch: "Borrar búsqueda",
        rowCount: "{{visible}} de {{total}} filas",
        firstRowHeader: "La primera fila es el encabezado",
        clearFilters: "Borrar filtros",
        truncated: "La vista previa está limitada por el tamaño máximo del CSV.",
        raggedRows: "{{count}} filas tienen un número de campos inesperado",
        jumpToRow: "Ir a la primera",
        empty: "No hay filas",
        tooLarge: "Este CSV es demasiado grande para la cuadrícula. Abre Código fuente para verlo.",
        tooManyValues: "Más de {{count}} valores distintos. Escribe para filtrar.",
        filterValues: "Filtrar valores",
        filterAccessibility: "Filtrar {{column}}",
        selectAll: "Seleccionar todo",
        clear: "Borrar",
        ...
        copyRow: "Copiar fila",
        copyVisibleRows: "Copiar filas visibles",
        copyPending: "Copiando...",
        copySuccess: "Copiado",
    ...
    notes: {
      label: "Notas",
      subtitle: "Notas del proyecto",
      tooltip: "Notas escritas por agentes en este proyecto",
      newNote: "Nueva nota",
      emptyTitle: "No hay notas en este proyecto",
      emptyDescription: "Los agentes las escriben con write_note.",
      loadFailed: "No se pudieron cargar las notas",
      hostTooOld: "Actualiza el host para ver las notas.",
      disconnected: "El host está desconectado",
      hostsUnavailable: "Algunos hosts del proyecto no están disponibles",
      hostHeading: "{{host}}",
      hostTag: "Host: {{host}}",
      hostUnreachable: "{{host}} no está disponible.",
      hostUnsupported: "{{host}} no admite notas.",
      hostLoadFailed: "No se pudieron cargar las notas desde {{host}}.",
      updated: "Actualizada {{time}}",
      loadImage: "Cargar imagen remota",
      unsavedChanges: "Cambios sin guardar",
      saving: "Guardando...",
      saveFailed: "Error al guardar",
      staleWriteTitle: "La nota cambió mientras la editabas",
      staleWriteDescription: "Tu guardado reemplazó la revisión {{revision}}.",
      changedTitle: "La nota cambió en otro lugar",
      reload: "Recargar",
      reloadTitle: "¿Recargar la nota?",
      reloadMessage: "Se perderán tus cambios locales.",
      delete: "Eliminar",
      deleteTitle: "¿Eliminar la nota?",
      deleteMessage: '¿Eliminar "{{title}}"? Esta acción no se puede deshacer.',
      deleteConfirm: "Eliminar",
      deleteFailed: "No se pudo eliminar la nota",
      deleteConflict: "Eliminación rechazada. La nota está ahora en la revisión {{revision}}.",
    },
    pullRequest: {
