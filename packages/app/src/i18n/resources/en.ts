export const en = {
  ...
  panels: {
    ...
    file: {
      ...
      csv: {
        searchPlaceholder: "Search headers and rows",
        clearSearch: "Clear search",
        rowCount: "{{visible}} of {{total}} rows",
        firstRowHeader: "First row is header",
        clearFilters: "Clear filters",
        truncated: "This preview is truncated at the CSV size limit.",
        raggedRows: "{{count}} rows have an unexpected number of fields",
        jumpToRow: "Jump to first",
        empty: "No rows",
        tooLarge: "This CSV is too large for the grid. Open Source to view it.",
        tooManyValues: "More than {{count}} distinct values. Type to filter.",
        filterValues: "Filter values",
        filterAccessibility: "Filter {{column}}",
        selectAll: "Select all",
        clear: "Clear",
        ...
        copyCell: "Copy cell",
        copyRow: "Copy row",
        copyVisibleRows: "Copy visible rows",
        copyPending: "Copying...",
        copySuccess: "Copied",
        copyFailed: "Copy failed",
      },
    ...
    notes: {
      ...
      newNote: "New note",
      emptyTitle: "No notes in this project",
      emptyDescription: "Agents write them with write_note.",
      loadFailed: "Failed to load notes",
      hostTooOld: "Update the host to view notes.",
      disconnected: "Host is disconnected",
      hostsUnavailable: "Some project hosts are unavailable",
      hostHeading: "{{host}}",
      hostTag: "Host: {{host}}",
      hostUnreachable: "{{host}} is unreachable.",
      hostUnsupported: "{{host}} does not support notes.",
      hostLoadFailed: "Could not load notes from {{host}}.",
      updated: "Updated {{time}}",
      loadImage: "Load remote image",
      unsavedChanges: "Unsaved changes",
      saving: "Saving...",
      saveFailed: "Save failed",
      staleWriteTitle: "Note changed while you were editing",
      staleWriteDescription: "Your save replaced revision {{revision}}.",
      changedTitle: "Note changed elsewhere",
      reload: "Reload",
      reloadTitle: "Reload note?",
      reloadMessage: "Your local changes will be lost.",
      delete: "Delete",
      ...
      deleteConflict: "Delete refused. The note is now at revision {{revision}}.",
    },
    pullRequest: {
      label: "Pull request",
