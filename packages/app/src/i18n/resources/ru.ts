...
export const ru: TranslationResources = {
  ...
  sidebar: {
    ...
    workspace: {
      ...
      actions: {
        ...
        hiding: "Скрытие...",
        delete: "Удалить",
        deleteUnavailable: "У этого рабочего пространства нет worktree для удаления",
      },
      confirmations: {
        ...
        deleteMessage:
          "Архивирует «{{workspaceName}}» и удаляет каталог worktree вместе с игнорируемыми файлами, такими как node_modules и .env.\n\nGit откажет, если есть незакоммиченные изменения.",
      ...
      toasts: {
        ...
        worktreeKeptDirty:
          "Заархивировано. В worktree есть незакоммиченные изменения, поэтому Git его оставил.",
        worktreeKeptLocked: "Заархивировано. Worktree заблокирован, поэтому Git его оставил.",
        worktreeKeptUnrecognised:
          "Заархивировано. Git больше не распознаёт каталог worktree — удалите его вручную.",
        worktreeKeptUnknown: "Заархивировано, но Git не удалил worktree.",
      },
    },
  },
  newWorkspace: {
  ...
  panels: {
    ...
    file: {
      ...
      csv: {
        searchPlaceholder: "Поиск по заголовкам и строкам",
        clearSearch: "Очистить поиск",
        rowCount: "{{visible}} из {{total}} строк",
        firstRowHeader: "Первая строка — заголовок",
        clearFilters: "Очистить фильтры",
        truncated: "Предпросмотр обрезан по ограничению размера CSV.",
        raggedRows: "В {{count}} строках неожиданное число полей",
        jumpToRow: "Перейти к первой",
        empty: "Нет строк",
        tooLarge: "Этот CSV слишком велик для таблицы. Откройте исходный текст.",
        tooManyValues: "Больше {{count}} разных значений. Введите текст для фильтрации.",
        filterValues: "Фильтр значений",
        filterAccessibility: "Фильтр {{column}}",
        ...
        copyVisibleRows: "Копировать видимые строки",
        copyPending: "Копирование...",
    ...
    notes: {
      label: "Заметки",
      subtitle: "Заметки проекта",
      tooltip: "Заметки, созданные агентами в этом проекте",
      newNote: "Новая заметка",
      emptyTitle: "В этом проекте нет заметок",
      emptyDescription: "Агенты создают их с помощью write_note.",
      loadFailed: "Не удалось загрузить заметки",
      hostTooOld: "Обновите хост, чтобы просматривать заметки.",
      disconnected: "Хост отключён",
      hostsUnavailable: "Некоторые хосты проекта недоступны",
      hostHeading: "{{host}}",
      hostTag: "Хост: {{host}}",
      hostUnreachable: "Хост {{host}} недоступен.",
      hostUnsupported: "Хост {{host}} не поддерживает заметки.",
      hostLoadFailed: "Не удалось загрузить заметки с хоста {{host}}.",
      updated: "Обновлено {{time}}",
      loadImage: "Загрузить удалённое изображение",
      unsavedChanges: "Несохранённые изменения",
      saving: "Сохранение...",
      saveFailed: "Не удалось сохранить",
      staleWriteTitle: "Заметка изменилась во время редактирования",
      staleWriteDescription: "Сохранение заменило ревизию {{revision}}.",
      changedTitle: "Заметка изменена в другом месте",
      reload: "Перезагрузить",
      reloadTitle: "Перезагрузить заметку?",
      reloadMessage: "Локальные изменения будут потеряны.",
      delete: "Удалить",
      ...
      deleteConflict: "Удаление отклонено. Текущая ревизия заметки: {{revision}}.",
    },
    pullRequest: {
      label: "PR",
