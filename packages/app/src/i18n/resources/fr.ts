...
export const fr: TranslationResources = {
  ...
  workspace: {
    ...
    browser: {
      ...
      errors: {
        ...
        invalidUrl: "Navigateur URL invalide",
        unsupportedProtocol: "Navigateur non pris en charge bloqué URL:{{protocol}}",
      },
    },
    terminal: {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          mergePrNoGithub:
            "La fusion PR n'est pas disponible pour le moment car GitHub n'est pas connecté",
          archiveNotWorktree:
            "L'archive n'est pas disponible ici car cet espace de travail n'a pas été créé en tant qu'arbre de travail Paseo",
          mergePrNoForge:
  ...
  desktop: {
    ...
    daemon: {
      ...
      keepRunning: {
        ...
        hint: "Daemoncontinue de fonctionner lorsque vous quittez Paseo",
      },
      logs: {
    ...
    rosetta: {
      ...
      runningIntel: "Vous exécutez la versionIntelde Paseo sousRosettasurApple Silicon.",
      highCpu:
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Impossible d'installer le Paseo CLI.",
      },
    },
  },
  rootError: {
  ...
  pairing: {
    ...
    device: {
      ...
      hint: "Scannez ce codeQRavec Paseo sur votre téléphone ou copiez le lien ci-dessous.",
      securityWarning:
  ...
  panels: {
    ...
    file: {
      ...
      csv: {
        searchPlaceholder: "Rechercher dans les en-têtes et les lignes",
        clearSearch: "Effacer la recherche",
        rowCount: "{{visible}} sur {{total}} lignes",
        firstRowHeader: "La première ligne est l'en-tête",
        clearFilters: "Effacer les filtres",
        truncated: "L'aperçu est tronqué à la limite de taille du CSV.",
        raggedRows: "{{count}} lignes ont un nombre de champs inattendu",
        jumpToRow: "Aller à la première",
        empty: "Aucune ligne",
        tooLarge: "Ce CSV est trop volumineux pour la grille. Ouvrez la source pour l'afficher.",
        tooManyValues: "Plus de {{count}} valeurs distinctes. Saisissez du texte pour filtrer.",
        filterValues: "Filtrer les valeurs",
        filterAccessibility: "Filtrer {{column}}",
        selectAll: "Tout sélectionner",
        clear: "Effacer",
        ...
        copyVisibleRows: "Copier les lignes visibles",
        copyPending: "Copie...",
        copySuccess: "Copié",
        copyFailed: "Échec de la copie",
      },
    ...
    notes: {
      label: "Notes",
      subtitle: "Notes du projet",
      tooltip: "Notes écrites par les agents dans ce projet",
      newNote: "Nouvelle note",
      emptyTitle: "Aucune note dans ce projet",
      emptyDescription: "Les agents les écrivent avec write_note.",
      loadFailed: "Échec du chargement des notes",
      hostTooOld: "Mettez l’hôte à jour pour afficher les notes.",
      disconnected: "L’hôte est déconnecté",
      hostsUnavailable: "Certains hôtes du projet sont indisponibles",
      hostHeading: "{{host}}",
      hostTag: "Hôte : {{host}}",
      hostUnreachable: "{{host}} est inaccessible.",
      hostUnsupported: "{{host}} ne prend pas en charge les notes.",
      hostLoadFailed: "Impossible de charger les notes depuis {{host}}.",
      updated: "Mis à jour {{time}}",
      loadImage: "Charger l’image distante",
      unsavedChanges: "Modifications non enregistrées",
      saving: "Enregistrement...",
      saveFailed: "Échec de l’enregistrement",
      staleWriteTitle: "La note a changé pendant votre modification",
      staleWriteDescription: "Votre enregistrement a remplacé la révision {{revision}}.",
      changedTitle: "La note a changé ailleurs",
      reload: "Recharger",
      reloadTitle: "Recharger la note ?",
      reloadMessage: "Vos modifications locales seront perdues.",
      delete: "Supprimer",
      ...
      deleteConflict: "Suppression refusée. La note est maintenant à la révision {{revision}}.",
    },
    pullRequest: {
  ...
  settings: {
    ...
    general: {
      ...
      noteImages: {
        label: "Remote note images",
        description: "Choose when remote images in Notes load",
        accessibilityLabel: "Select remote note image behavior ({{value}})",
        options: {
          auto: "Load automatically",
          tapToLoad: "Load on tap",
          disabled: "Never load",
        },
      },
      terminalScrollback: {
    ...
    project: {
      ...
      metadata: {
        title: "Génération de métadonnées",
        info: "Instructions spécifiques au projet injectées dans les invites de l'IA que Paseo utilise pour générer des métadonnées: utilisez-les pour appliquer les conventions de votre équipe telles que la dénomination des branches, le style de validation ou le format PR.",
