...
export const zhCN: TranslationResources = {
  ...
  workspace: {
    route: {
      ...
      recovery: {
        ...
        removeWorktreeAction: "删除 worktree",
        removeWorktreeInProgress: "正在删除...",
        removeWorktreeTitle: "要删除 worktree 吗？",
        removeWorktreeMessage:
          "将删除 {{path}} 及其中的所有内容，包括 node_modules 和 .env 等被忽略的文件。如果有未提交的更改，git 会拒绝。",
        removeWorktreeConfirm: "删除",
        removeWorktreeDone: "已删除 worktree",
        removeWorktreeRefused: "git 未能删除 worktree",
        removeWorktreeTerminal: "git 已不再识别此目录，因此 Paseo 无法删除。请自行删除：",
  ...
  sidebar: {
    ...
    workspace: {
      ...
      actions: {
        ...
        hiding: "正在隐藏...",
        delete: "删除",
        deleteUnavailable: "此工作区没有可删除的 worktree",
      },
      confirmations: {
        ...
        deleteTitle: "删除工作区？",
        deleteMessage:
          "归档“{{workspaceName}}”并删除其 worktree 目录，包括 node_modules 和 .env 等被忽略的文件。\n\n如果存在未提交的更改，Git 会拒绝。",
        deleteConfirm: "删除",
        cancel: "取消",
      },
      rename: {
      ...
      toasts: {
        ...
        worktreeKeptDirty: "已归档。worktree 中有未提交的更改，Git 保留了它。",
        worktreeKeptLocked: "已归档。worktree 已锁定，Git 保留了它。",
        worktreeKeptUnrecognised: "已归档。Git 不再识别该 worktree 目录，请自行删除。",
        worktreeKeptUnknown: "已归档，但 Git 未能删除 worktree。",
      },
    },
  },
  newWorkspace: {
  ...
  panels: {
    ...
    file: {
      ...
      csv: {
        searchPlaceholder: "搜索表头和行",
        clearSearch: "清除搜索",
        rowCount: "{{total}} 行中的 {{visible}} 行",
        firstRowHeader: "第一行是表头",
        clearFilters: "清除筛选",
        truncated: "预览已达到 CSV 大小限制并被截断。",
        raggedRows: "{{count}} 行的字段数与预期不符",
        jumpToRow: "跳转到第一行",
        empty: "没有行",
        tooLarge: "此 CSV 太大，无法使用网格显示。请打开源代码查看。",
        tooManyValues: "不同值超过 {{count}} 个。输入内容进行筛选。",
        filterValues: "筛选值",
        filterAccessibility: "筛选 {{column}}",
        selectAll: "全选",
        clear: "清除",
    ...
    artifacts: {
      ...
      openOn: "在 {{host}} 上打开",
      deleteTitle: "删除 Agent 成果物？",
      deleteMessage: "删除“{{title}}”？此操作无法撤销。",
      deleteConfirm: "删除",
      deleteFailed: "无法删除成果物",
    },
    notes: {
      label: "笔记",
      subtitle: "项目笔记",
      tooltip: "此项目中由代理编写的笔记",
      newNote: "新建笔记",
      emptyTitle: "此项目中没有笔记",
      emptyDescription: "代理使用 write_note 创建笔记。",
      loadFailed: "加载笔记失败",
      hostTooOld: "更新主机后才能查看笔记。",
      disconnected: "主机已断开连接",
      hostsUnavailable: "部分项目主机不可用",
      hostHeading: "{{host}}",
      hostTag: "主机：{{host}}",
      hostUnreachable: "无法访问 {{host}}。",
      hostUnsupported: "{{host}} 不支持笔记。",
      hostLoadFailed: "无法从 {{host}} 加载笔记。",
      updated: "更新于 {{time}}",
      loadImage: "加载远程图片",
      unsavedChanges: "未保存的更改",
      saving: "保存中...",
      saveFailed: "保存失败",
      staleWriteTitle: "编辑时笔记发生了更改",
      staleWriteDescription: "你的保存替换了版本 {{revision}}。",
      changedTitle: "笔记已在其他位置更改",
      reload: "重新加载",
      reloadTitle: "重新加载笔记？",
      reloadMessage: "你的本地更改将会丢失。",
      delete: "删除",
      deleteTitle: "删除笔记？",
      deleteMessage: "删除“{{title}}”？此操作无法撤销。",
      deleteConfirm: "删除",
      deleteFailed: "删除笔记失败",
      deleteConflict: "删除被拒绝。笔记当前为版本 {{revision}}。",
    },
    pullRequest: {
      label: "拉取请求",
      subtitle: "拉取请求详情",
