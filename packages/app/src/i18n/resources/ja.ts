...
export const ja: TranslationResources = {
  ...
  sidebar: {
    ...
    workspace: {
      ...
      actions: {
        ...
        hiding: "非表示にしています...",
        delete: "削除",
        deleteUnavailable: "このワークスペースには削除する worktree がありません",
      },
      confirmations: {
        ...
        hideConfirm: "非表示",
        deleteTitle: "ワークスペースを削除しますか？",
        deleteMessage:
          "「{{workspaceName}}」をアーカイブし、node_modules や .env などの無視されたファイルを含む worktree ディレクトリを削除します。\n\nコミットされていない変更がある場合、Git は拒否します。",
        deleteConfirm: "削除",
        cancel: "キャンセル",
      },
      rename: {
      ...
      toasts: {
        ...
        worktreeKeptDirty:
          "アーカイブしました。worktree にコミットされていない変更があるため、Git は削除しませんでした。",
        worktreeKeptLocked:
          "アーカイブしました。worktree がロックされているため、Git は削除しませんでした。",
        worktreeKeptUnrecognised:
          "アーカイブしました。Git は worktree ディレクトリを認識できないため、手動で削除してください。",
        worktreeKeptUnknown: "アーカイブしましたが、Git は worktree を削除しませんでした。",
      },
    },
  },
  newWorkspace: {
  ...
  panels: {
    ...
    file: {
      ...
      csv: {
        searchPlaceholder: "ヘッダーと行を検索",
        clearSearch: "検索を消去",
        rowCount: "{{total}} 行中 {{visible}} 行",
        firstRowHeader: "1 行目をヘッダーにする",
        clearFilters: "フィルターをクリア",
        truncated: "CSV のサイズ上限でプレビューを切り詰めました。",
        raggedRows: "{{count}} 行のフィールド数が一致しません",
        jumpToRow: "先頭へ移動",
        empty: "行がありません",
        tooLarge: "この CSV はグリッドには大きすぎます。ソースを開いて表示してください。",
        tooManyValues: "{{count}} 件を超える異なる値があります。入力して絞り込んでください。",
        filterValues: "値を絞り込む",
        filterAccessibility: "{{column}} を絞り込む",
        selectAll: "すべて選択",
        clear: "クリア",
        selected: "{{count}} 件を選択",
        values: "値",
    ...
    notes: {
      label: "ノート",
      subtitle: "プロジェクトのノート",
      tooltip: "このプロジェクトでエージェントが書いたノート",
      newNote: "新しいノート",
      emptyTitle: "このプロジェクトにノートはありません",
      emptyDescription: "エージェントは write_note で作成します。",
      loadFailed: "ノートを読み込めませんでした",
      hostTooOld: "ノートを表示するにはホストを更新してください。",
      disconnected: "ホストが接続されていません",
      hostsUnavailable: "プロジェクトの一部のホストを利用できません",
      hostHeading: "{{host}}",
      hostTag: "ホスト: {{host}}",
      hostUnreachable: "{{host}} に接続できません。",
      hostUnsupported: "{{host}} はノートに対応していません。",
      hostLoadFailed: "{{host}} からノートを読み込めませんでした。",
      updated: "更新 {{time}}",
      loadImage: "リモート画像を読み込む",
      unsavedChanges: "未保存の変更",
      saving: "保存中...",
      saveFailed: "保存に失敗しました",
      staleWriteTitle: "編集中にノートが変更されました",
      staleWriteDescription: "保存によってリビジョン {{revision}} が置き換えられました。",
      changedTitle: "ノートが別の場所で変更されました",
      reload: "再読み込み",
      reloadTitle: "ノートを再読み込みしますか？",
      reloadMessage: "ローカルの変更は失われます。",
      delete: "削除",
      ...
      deleteConflict: "削除できません。ノートは現在リビジョン {{revision}} です。",
    },
    pullRequest: {
      label: "プルリクエスト",
      subtitle: "プルリクエストの詳細",
