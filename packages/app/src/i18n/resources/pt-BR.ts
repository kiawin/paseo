...
export const ptBR: TranslationResources = {
  ...
  sidebar: {
    ...
    workspace: {
      ...
      actions: {
        ...
        hiding: "Ocultando...",
        delete: "Excluir",
        deleteUnavailable: "Este espaço de trabalho não tem worktree para excluir",
      },
      confirmations: {
        ...
        deleteMessage:
          'Arquiva "{{workspaceName}}" e exclui o diretório do worktree, incluindo arquivos ignorados como node_modules e .env.\n\nO Git recusa se houver trabalho não commitado.',
      ...
      toasts: {
        ...
        worktreeKeptDirty:
          "Arquivado. O worktree tem trabalho não commitado, então o Git o manteve.",
        worktreeKeptLocked: "Arquivado. O worktree está bloqueado, então o Git o manteve.",
        worktreeKeptUnrecognised:
          "Arquivado. O Git não reconhece mais o diretório do worktree, então exclua-o você mesmo.",
        worktreeKeptUnknown: "Arquivado, mas o Git não removeu o worktree.",
      },
    },
  },
  newWorkspace: {
  ...
  panels: {
    ...
    file: {
      ...
      csv: {
        searchPlaceholder: "Pesquisar cabeçalhos e linhas",
        clearSearch: "Limpar pesquisa",
        rowCount: "{{visible}} de {{total}} linhas",
        firstRowHeader: "A primeira linha é o cabeçalho",
        clearFilters: "Limpar filtros",
        truncated: "A prévia foi truncada no limite de tamanho do CSV.",
        raggedRows: "{{count}} linhas têm um número inesperado de campos",
        jumpToRow: "Ir para a primeira",
        empty: "Nenhuma linha",
        tooLarge: "Este CSV é grande demais para a grade. Abra a fonte para vê-lo.",
        tooManyValues: "Mais de {{count}} valores distintos. Digite para filtrar.",
        ...
        copyVisibleRows: "Copiar linhas visíveis",
    ...
    notes: {
      label: "Notas",
      subtitle: "Notas do projeto",
      tooltip: "Notas escritas por agentes neste projeto",
      newNote: "Nova nota",
      emptyTitle: "Nenhuma nota neste projeto",
      emptyDescription: "Os agentes as escrevem com write_note.",
      loadFailed: "Falha ao carregar notas",
      hostTooOld: "Atualize o host para ver as notas.",
      disconnected: "O host está desconectado",
      hostsUnavailable: "Alguns hosts do projeto estão indisponíveis",
      hostHeading: "{{host}}",
      hostTag: "Host: {{host}}",
      hostUnreachable: "{{host}} está inacessível.",
      hostUnsupported: "{{host}} não oferece suporte a notas.",
      hostLoadFailed: "Não foi possível carregar notas de {{host}}.",
      updated: "Atualizado {{time}}",
      loadImage: "Carregar imagem remota",
      unsavedChanges: "Alterações não salvas",
      saving: "Salvando...",
      saveFailed: "Falha ao salvar",
      staleWriteTitle: "A nota mudou enquanto você editava",
      staleWriteDescription: "Seu salvamento substituiu a revisão {{revision}}.",
      changedTitle: "A nota mudou em outro lugar",
      reload: "Recarregar",
      reloadTitle: "Recarregar a nota?",
      reloadMessage: "Suas alterações locais serão perdidas.",
      delete: "Excluir",
      deleteTitle: "Excluir nota?",
      deleteMessage: 'Excluir "{{title}}"? Esta ação não pode ser desfeita.',
      deleteConfirm: "Excluir",
      deleteFailed: "Falha ao excluir nota",
      deleteConflict: "Exclusão recusada. A nota agora está na revisão {{revision}}.",
    },
    pullRequest: {
      label: "Pull request",
