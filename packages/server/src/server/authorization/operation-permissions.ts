...
const INBOUND_PERMISSION = {
  ...
  // Reading an artifact is project-wide by design — that is the sharing boundary. Deleting and
  // pinning change someone else's deliverable, so they take the write right.
  "artifact.delete.request": "workspace.write",
  "artifact.entry.download.request": "workspace.read",
  "artifact.list.request": "workspace.read",
  "artifact.pin.set.request": "workspace.write",
  "note.delete.request": "workspace.write",
  "note.list.request": "workspace.read",
  "note.read.request": "workspace.read",
  "note.save.request": "workspace.write",
  ...
  "fs.entry.download.request": "workspace.read",
  "fs.entry.duplicate.request": "workspace.write",
  "fs.entry.rename.request": "workspace.write",
  "fs.entry.upload.request": "workspace.write",
  "fs.file.subscribe.request": "workspace.read",
  "fs.file.unsubscribe.request": "workspace.read",
  "fs.file.write.request": "workspace.write",
  // Flow control for a transfer that was already authorized by its originating
  // request, and the registries these look up are per-session, so a principal can
  // only ack or cancel its own in-flight transfer. Requiring write here would lock
  // a read-only principal out of acking the download it is allowed to make.
  "fs.transfer.ack": "workspace.read",
  "fs.transfer.cancel": "workspace.read",
  ...
  "project.worktree.location.set.request": "workspace.manage",
  "workspace.worktree.remove.request": "workspace.manage",
  ...
  "workspace.agentTools.set.request": "workspace.manage",
...
const OUTBOUND_PERMISSION = {
  ...
  "artifact.changed": "workspace.read",
  "artifact.delete.response": "workspace.write",
  "artifact.entry.download.response": "workspace.read",
  "artifact.list.response": "workspace.read",
  "artifact.pin.set.response": "workspace.write",
  "note.changed": "workspace.read",
  "note.delete.response": "workspace.write",
  "note.list.response": "workspace.read",
  "note.read.response": "workspace.read",
  "note.save.response": "workspace.write",
  ...
  "project.worktree.location.set.response": "workspace.manage",
  "workspace.worktree.remove.response": "workspace.manage",
  ...
  "workspace.agentTools.set.response": "workspace.manage",
